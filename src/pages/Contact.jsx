...
export default function Contact() {
  return (
    <div className="page-container" style={{ padding: '4rem 2rem', minHeight: '80vh', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: '3rem', padding: '2.5rem', background: 'var(--bg-secondary)', borderRadius: '24px', border: '1px solid var(--border-color)', maxWidth: '800px', width: '100%' }}>
